          ...
          <div className="grid lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-card rounded-xl shadow-lg p-8 border border-border space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Laval, QC, Canada</p>
                  </div>
                </div>
              ...
              <div className="rounded-xl overflow-hidden shadow-lg border border-border">
                <iframe
                  title="Inal Resources - Laval, QC"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d89217.47362070877!2d-73.78844685!3d45.5844906!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4cc923a4f2db3d61%3A0x5040cadae4d7580!2sLaval%2C%20QC!5e0!3m2!1sen!2sca!4v1700000000000"
                  width="100%"
                  height="280"
                  style={{ border: 0 }}
                  allowFullScreen
