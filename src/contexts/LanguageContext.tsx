...
const translations: Translations = {
  ...
  "jobs.clearFilters": { en: "Clear", fr: "Effacer" },
  ...
  "jobs.errorTitle": { en: "Error loading jobs", fr: "Erreur de chargement" },
  "jobs.errorDesc": { en: "Please try again later.", fr: "Veuillez réessayer plus tard." },
