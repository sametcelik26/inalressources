...
const translations: Translations = {
  ...
  "candidate.browseFiles": { en: "Browse Files", fr: "Parcourir les fichiers" },
  "candidate.dragDrop": { en: "or drag and drop your file here", fr: "ou glissez-déposez votre fichier ici" },
  "candidate.cvHelper": { en: "PDF, DOC or DOCX (max 5MB)", fr: "PDF, DOC ou DOCX (max 5 Mo)" },
